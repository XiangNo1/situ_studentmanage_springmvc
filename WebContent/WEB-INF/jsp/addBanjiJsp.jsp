...
<link rel="stylesheet" href="${pageContext.request.contextPath }/lib/bootstrap/css/bootstrap.css" />
		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji/findBanji.action" class="list-group-item">班级管理</a>
		                <a href="${pageContext.request.contextPath}/banji/addBanji.action" class="list-group-item active">班级添加</a>
		            </div>
		        </div>
		        <div class="col-md-10">
 ...
 <form action="${pageContext.request.contextPath}/banji/addBanji2.action" method="post">
