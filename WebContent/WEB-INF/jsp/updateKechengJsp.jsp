  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<form action="${pageContext.request.contextPath }/banji/updateKecheng2.action" method="post">
 		id：<input class="form-control" type="text" name="id" value="${requestScope.kecheng.id }" readonly="readonly"/><br/>
   		   课程：<input class="form-control" type="text" name="name" value="${requestScope.kecheng.name }"/><br/>
   		    学分：<input class="form-control" type="text" name="credit" value="${requestScope.kecheng.credit }"/><br/>
